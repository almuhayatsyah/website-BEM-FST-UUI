...
<section class="content">
  <div class="container-fluid">
    <div class="card">
      ...
      <div class="card-body">
        <form action="<?= base_url('hubungi-kami/update/' . $hubungi_kami['id']) ?>" method="POST">
          <?= csrf_field() ?>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control <?= session('errors.instagram') ? 'is-invalid' : '' ?>"
              ...
              value="<?= old('instagram', $hubungi_kami['instagram']) ?>">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control <?= session('errors.tiktok') ? 'is-invalid' : '' ?>"
              ...
              value="<?= old('tiktok', $hubungi_kami['tiktok']) ?>">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control <?= session('errors.whatsapp') ? 'is-invalid' : '' ?>"
              id="whatsapp" name="whatsapp" placeholder="+62xxx"
              value="<?= old('whatsapp', $hubungi_kami['whatsapp']) ?>">
