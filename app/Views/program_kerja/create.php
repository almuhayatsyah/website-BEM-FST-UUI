      ...
      <form action="<?= base_url('program-kerja/store') ?>" method="post">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_program_kerja" name="nama_program_kerja" value="<?= old('nama_program_kerja') ?>" required>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="sasaran" name="sasaran" value="<?= old('sasaran') ?>" required>
          </div>

          <div class="form-group">
            <label for="target_pelaksanaan">Target Pelaksanaan</label>
            <input type="text" class="form-control" id="target_pelaksanaan" name="target_pelaksanaan" value="<?= old('target_pelaksanaan') ?>" required>
          </div>
